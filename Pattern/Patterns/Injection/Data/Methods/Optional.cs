...
namespace Injection.Optional.Methods.WithDefault
{
...
namespace Injection.Optional.Methods.WithDefaultAttribute
{
#if !BEHAVIOR_V4 // v4 did not support optional value types
...
namespace Injection.Optional.Methods.WithDefaultAndAttribute
{
#if !BEHAVIOR_V4 // v4 did not support optional value types
