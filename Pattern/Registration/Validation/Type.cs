...
namespace Registration
{
    public partial class Validation
    {
        ...
        public void RegisterType_Validation(Type typeFrom, Type typeTo, string name, ITypeLifetimeManager lifetimeManager, Type manager)
        {
            // Act
        ...
        public void RegisterType_Failing(Type exception, Type typeFrom, Type typeTo, string name, ITypeLifetimeManager lifetimeManager, params InjectionMember[] injectionMembers)
        {
            try
            {
                // Act
